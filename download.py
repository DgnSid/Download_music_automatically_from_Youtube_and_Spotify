...
import os
import yt_dlp  # Remplace youtube_dl
import spotipy
...
## YouTube downloader options - OPTIMISÉ
ydl_opts = {
    'format': 'bestaudio/best',
    'outtmpl': '%(title)s.%(ext)s',  # Ajouté pour mieux gérer les noms de fichiers
    'postprocessors': [{
...
def download_song(song_url):
    with yt_dlp.YoutubeDL(ydl_opts) as ydl:  # Changé pour yt_dlp
